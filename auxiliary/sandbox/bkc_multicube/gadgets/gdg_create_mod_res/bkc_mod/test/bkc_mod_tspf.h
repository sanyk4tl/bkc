 ...
 *****************************************************************************
 *  module: bkc_mod
 *  file name: bkc_mod_tspf.h
 *  description: supporting utilites for testing the bkc_mod module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_MOD_TSPF_H
#define BKC_MOD_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_mod_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_mod_tspf_free_func_t)(void *mem_p);
