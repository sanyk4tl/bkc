 ...
 *************************************************************************
 *  module: bkc_dlist
 *  file name: bkc_dlist_tspf.h
 *  description: supporting utilites for the bkc_dlist_test
 *************************************************************************
 *  log:
 *  >>>
 *  version: 
 ...
 *  description: created
 ************************************************************************/
#ifndef BKC_DLIST_TSPF_H
#define BKC_DLIST_TSPF_H
/*********************included files*************************************/

/*********************definition, types & constants ***********************/
/*for memory diagnose*/
typedef void *(*bkc_dlist_tspf_malloc_func_t)(unsigned int size);
typedef	void (*bkc_dlist_tspf_free_func_t)(void *mem_p);
