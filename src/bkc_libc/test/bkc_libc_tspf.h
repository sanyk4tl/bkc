 ...
 *************************************************************************
 *  module: bkc_libc
 *  file name: bkc_libc_tspf.h
 *  description: supporting utilites for testing the bkc_libc module
 *************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ************************************************************************/
#ifndef BKC_LIBC_TSPF_H
#define BKC_LIBC_TSPF_H
/*********************included files*************************************/

/*********************definition, types & constants ***********************/
/*for memory diagnose*/
typedef void *(*bkc_libc_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_libc_tspf_free_func_t)(void *mem_p);
