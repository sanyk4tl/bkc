 ...
 *****************************************************************************
 *  module: bkc_socket
 *  file name: bkc_socket_tspf.h
 *  description: supporting utilites for testing the bkc_socket module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_SOCKET_TSPF_H
#define BKC_SOCKET_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_socket_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_socket_tspf_free_func_t)(void *mem_p);
