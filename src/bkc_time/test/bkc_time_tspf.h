 ...
 *****************************************************************************
 *  module: bkc_time
 *  file name: bkc_time_tspf.h
 *  description: supporting utilites for testing the bkc_time module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_TIME_TSPF_H
#define BKC_TIME_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_time_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_time_tspf_free_func_t)(void *mem_p);
