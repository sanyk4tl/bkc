 ...
 *************************************************************************
 *  module: bkc_regex
 *  file name: bkc_regex_tspf.h
 *  description: supporting utilites for testing the bkc_regex module
 *************************************************************************
 *  log:
 *  >>>
 *  version: 
 ...
 *  description: created
 ************************************************************************/
#ifndef BKC_REGEX_TSPF_H
#define BKC_REGEX_TSPF_H
/*********************included files*************************************/

/*********************definition, types & constants ***********************/
/*for memory diagnose*/
typedef void *(*bkc_regex_tspf_malloc_func_t)(unsigned int size);
typedef	void (*bkc_regex_tspf_free_func_t)(void *mem_p);
