 ...
 *****************************************************************************
 *  module: bkc_pthread
 *  file name: bkc_pthread_tspf.h
 *  description: supporting utilites for testing the bkc_pthread module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_PTHREAD_TSPF_H
#define BKC_PTHREAD_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_pthread_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_pthread_tspf_free_func_t)(void *mem_p);
