 ...
 *****************************************************************************
 *  module: bkc_crc
 *  file name: bkc_crc_tspf.h
 *  description: supporting utilites for testing the bkc_crc module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_CRC_TSPF_H
#define BKC_CRC_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_crc_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_crc_tspf_free_func_t)(void *mem_p);
