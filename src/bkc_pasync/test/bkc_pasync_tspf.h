 ...
 *****************************************************************************
 *  module: bkc_pasync
 *  file name: bkc_pasync_tspf.h
 *  description: supporting utilites for testing the bkc_pasync module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_PASYNC_TSPF_H
#define BKC_PASYNC_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_pasync_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_pasync_tspf_free_func_t)(void *mem_p);
