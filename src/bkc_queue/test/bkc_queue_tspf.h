 ...
 *************************************************************************
 *  module: bkc_queue
 *  file name: bkc_queue_tspf.h
 *  description: supporting utilites for testing the bkc_queue module
 *************************************************************************
 *  log:
 *  >>>
 *  version: 
 ...
 *  description: created
 ************************************************************************/
#ifndef BKC_QUEUE_TSPF_H
#define BKC_QUEUE_TSPF_H
/*********************included files*************************************/

/*********************definition, types & constants ***********************/
/*for memory diagnose*/
typedef void *(*bkc_queue_tspf_malloc_func_t)(unsigned int size);
typedef	void (*bkc_queue_tspf_free_func_t)(void *mem_p);
