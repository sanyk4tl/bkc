 ...
 *****************************************************************************
 *  module: bkc_sandbox
 *  file name: bkc_sandbox_tspf.h
 *  description: supporting utilites for testing the bkc_sandbox module
 *****************************************************************************
 *  log:
 *  >>>
 *  version:
 ...
 *  description: created
 ****************************************************************************/
#ifndef BKC_SANDBOX_TSPF_H
#define BKC_SANDBOX_TSPF_H
/*********************included files*****************************************/

/*********************definition, types & constants *************************/
/*for memory diagnose*/
typedef void *(*bkc_sandbox_tspf_malloc_func_t)(unsigned int size);
typedef void (*bkc_sandbox_tspf_free_func_t)(void *mem_p);
